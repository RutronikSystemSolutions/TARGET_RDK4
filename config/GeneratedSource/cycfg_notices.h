...
#if !defined(CY8C4149AZE_S598)
#error "Unexpected MPN; expected DEVICE:=CY8C4149AZE-S598. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C4149AZE_S598) */
